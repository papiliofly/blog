            ...
            <g transform="translate(825.000000, 1100.000000)">
                ...
                <g id="Avataaar" stroke-width="1" fill-rule="evenodd" mask="url(#mask-4)">
                    ...
                    <g id="Clothing/Overall" transform="translate(0.000000, 170.000000)">
                        <defs>
                            <path
                                ...
                                id="react-path-1770"></path>
                        </defs>
                        <mask id="react-mask-1771" fill="white">
                            <use xlink:href="#react-path-1770"></use>
                        </mask>
                        <use id="Overall" fill="#B7C1DB" fill-rule="evenodd" xlink:href="#react-path-1770">
                        </use>
                        <g id="Color/Palette/Gray-01" mask="url(#react-mask-1771)" fill-rule="evenodd"
                            fill="#FF5C5C">
                    ...
                    <g id="Top" stroke-width="1" fill-rule="evenodd">
                        <defs>
                            <rect id="react-path-1698" x="0" y="0" width="264" height="280"></rect>
                            <path
                                ...
                                id="react-path-1699"></path>
                        </defs>
                        <mask id="react-mask-1696" fill="white">
                            <use xlink:href="#react-path-1698"></use>
                        </mask>
                        <g id="Mask"></g>
                        <g id="Top/Long-Hair/Mia-Wallace" mask="url(#react-mask-1696)">
                            <g transform="translate(-1.000000, 0.000000)">
                                ...
                                <g id="Hair" stroke-width="1" fill="none" fill-rule="evenodd"
                                    ...
                                    <mask id="react-mask-1697" fill="white">
                                        <use xlink:href="#react-path-1699"></use>
                                    </mask>
                                    <use id="Combined-Shape" fill="#E6E6E6" xlink:href="#react-path-1699"></use>
                                    <g id="Skin/👶🏽-03-Brown" mask="url(#react-mask-1697)" fill="#2C1B18">
                                        <g transform="translate(0.000000, 0.000000) " id="Color">
                                            <rect x="0" y="0" width="264" height="280"></rect>
                                        </g>
                                    </g>
                                </g>
                                <g id="Top/_Resources/Kurt" fill="none"
                                    transform="translate(62.000000, 85.000000)" stroke-width="1">
                                    <defs>
                                        <filter x="-0.8%" y="-2.0%" width="101.5%" height="108.0%"
                                            filterUnits="objectBoundingBox" id="react-filter-1729">
                                    ...
                                    <g id="Kurts" filter="url(#react-filter-1729)"
                                        ...
                                        <path
                                            ...
                                            id="It!" fill="#F4F4F4" fill-rule="nonzero"></path>
                                        <path
                                            ...
                                            id="Did" fill="#2F383B" fill-rule="nonzero"></path>
                                        <path
